...
import { InMemoryCreateUserService } from '@/test/mock/user-service/user'
...
describe('AuthenticationView Component', () => {
  ...
  it('should show validation errors on blur for empty fields', () => {
    ...
    const name = screen.getByPlaceholderText('Insira seu nome') as HTMLInputElement
    const email = screen.getByPlaceholderText('Insira seu email') as HTMLInputElement
    const password = screen.getByPlaceholderText('Insira uma senha') as HTMLInputElement
