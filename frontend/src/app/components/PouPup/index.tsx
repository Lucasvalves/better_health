  ...
  <div className={styles.container}>
    ...
    <form action="">
      ...
      <span className={styles.inputContainer}>
        ...
        <div className={styles.inputWrapper}>
        <label className={styles.label}>
          <span className={styles.icon}><WiTime9/></span>
          <input
            title="Hora"
            type="time"
            className={styles.input}
      ...
      <span className={styles.buttons}><ButtonGroup rightButtonLabel="Cancelar" leftButtonLabel="Editar" /></span>
    </form>
  </div>
)
