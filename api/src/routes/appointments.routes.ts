...
class AppointmentsRoutes {
	...
	getRoutes(): Router {
		...
		this.router.post(
			'/available-days',
			this.authMiddleware.auth.bind(this.authMiddleware),
			this.appointmentsController.availableDays.bind(
		...
		this.router.post(
			...
			this.authMiddleware.auth.bind(this.authMiddleware),
			this.appointmentsController.findAppointmentsPatient.bind(
				this.appointmentsController
			)
		)
		...
		this.router.delete(
			'/:id',
			this.authMiddleware.auth.bind(this.authMiddleware),
			this.appointmentsController.delete.bind(this.appointmentsController)
		)
