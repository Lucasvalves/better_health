...
class UsersRoutes {
	...
	getRoutes(): Router {
		 ...
		 *     description: Retrieve the data of the authenticated user using the token provided in the Authorization header.
		 *     tags:
		 *       - User
		 *     parameters:
		 *       - in: header
		 ...
		 *                 name: "Paulo Almeida"
		 *                 password: "$2b$10$M8gOGMvWmq9RFjBjLaklLOf4d7fj727aSTAPZtrEpEnxhogZ2rhVe"
		 *                 email: "pauloalmeida@update.com"
		 *                 oldPassword: "oldPassword@19265"
		 *                 newPassword: "newPassword@19265"
		 *                 avatar_url: "https://example.com/images/paulo-avatar.jpg"
		...
		this.router.get(
			'/',
			this.authMiddleware.auth.bind(this.authMiddleware),
			this.usersController.findUserById.bind(this.usersController)
		)
