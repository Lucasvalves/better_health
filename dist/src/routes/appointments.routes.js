...
class AppointmentsRoutes {
    constructor() {
        ...
        this.appointmentsController = new AppointmentsController_1.AppointmentsController();
    }
    getRoutes() {
        /**
         * @swagger
         ...
         */
        this.router.post('/', this.authMiddleware.auth.bind(this.authMiddleware), this.appointmentsController.store.bind(this.appointmentsController)),
            /**
             * @swagger
             * /appointments/filter:
             *   get:
             ...
             *         description: Unauthorized
             */
            this.router.get('/filter', this.authMiddleware.auth.bind(this.authMiddleware), this.appointmentsController.index.bind(this.appointmentsController));
        /**
         * @swagger
         ...
         *         description: Unauthorized
         */
        this.router.post('/available-days', this.authMiddleware.auth.bind(this.authMiddleware), this.appointmentsController.availableDays.bind(this.appointmentsController));
        return this.router;
    }
}
