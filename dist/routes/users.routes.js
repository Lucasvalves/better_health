...
class UsersRoutes {
    ...
    getRoutes() {
         ...
         */
        this.router.put('/', multer_1.upload.single('avatar_url'), this.authMiddleware.auth.bind(this.authMiddleware), this.usersController.update.bind(this.usersController));
        /**
         * @swagger
         * /users/auth:
         *   post:
