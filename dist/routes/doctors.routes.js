...
class DoctorsRoutes {
    constructor() {
        ...
        this.doctorsController = new DoctorsController_1.DoctorsController();
    }
    getRoutes() {
        /**
           * @swagger
           ...
           */
        this.router.post("/", this.authMiddleware.auth.bind(this.authMiddleware), this.doctorsController.store.bind(this.doctorsController));
        /**
     * @swagger
     * /doctors:
     *   get:
     ...
     */
        this.router.get("/", this.authMiddleware.auth.bind(this.authMiddleware), this.doctorsController.index.bind(this.doctorsController));
        /**
         * @swagger
         * /doctors/{id}:
         *   get:
         ...
         */
        this.router.get("/:id", this.authMiddleware.auth.bind(this.authMiddleware), this.doctorsController.findDoctorsById.bind(this.doctorsController));
        /**
         * @swagger
         * /doctors/crm/{crm}:
         *   get:
         ...
         *         description: Doctor doens't exists
         */
        this.router.get("/crm/:crm", this.authMiddleware.auth.bind(this.authMiddleware), this.doctorsController.findDoctorsByCrm.bind(this.doctorsController));
        /**
         * @swagger
         * /doctors/{id}:
         *   delete:
         ...
         *         description: Doctor doens't exists
         */
        this.router.delete("/:id", this.authMiddleware.auth.bind(this.authMiddleware), this.doctorsController.delete.bind(this.doctorsController));
        return this.router;
    }
}
