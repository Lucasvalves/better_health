...
class TimesRoutes {
    constructor() {
        ...
        this.timesController = new TimesController_1.TimesController();
    }
    getRoutes() {
        /**
         * @swagger
         ...
         */
        this.router.post('/', this.authMiddleware.auth.bind(this.authMiddleware), this.timesController.store.bind(this.timesController));
        /**
         * @swagger
         * /times:
         *   get:
         ...
         */
        this.router.get('/', this.authMiddleware.auth.bind(this.authMiddleware), this.timesController.find.bind(this.timesController));
        /**
         * @swagger
         * /times/specialties:
         *   get:
         ...
         *         description: Bad request
         */
        this.router.get('/specialties', this.authMiddleware.auth.bind(this.authMiddleware), this.timesController.findBySpecialties.bind(this.timesController));
        /**
         * @swagger
         * /times/{id}:
         *   delete:
         ...
         */
        this.router.delete('/:id', this.authMiddleware.auth.bind(this.authMiddleware), this.timesController.delete.bind(this.timesController));
        return this.router;
    }
}
exports.TimesRoutes = TimesRoutes;
